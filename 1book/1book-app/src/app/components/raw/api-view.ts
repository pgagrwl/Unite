...
export class ApiViewComponent implements OnInit {
  ...
  fetchData() {
    ...
    this.http
      .get(
        '${BaseUrl}/swaps/quotes?srcAsset=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee&dstAsset=0x111111111117dc0aa78b770fa6a738034120c302&amount=10000000000000000&chainId=1&protocol=BALANCER'
      )
      .subscribe({
        next: (res) => {
          this.data = res;
